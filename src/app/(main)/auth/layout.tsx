...
export default function Layout({ children }: LayoutProps) {
  return (
    <main>
      <div className="container relative mx-auto h-dvh flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
        <div className="relative hidden h-full flex-col items-center justify-center space-y-5 lg:flex">
          ...
          <div className="absolute right-5 bottom-5 left-5 flex justify-between text-gray-600 text-sm">
